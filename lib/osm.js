...
// `preGeo` (optional) skips the Nominatim call — the autopilot scheduler
// geocodes once at campaign creation and passes the stored point here.
export async function searchBusinesses(query, location, radiusKm = 5, preGeo = null) {
