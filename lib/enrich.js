...
const INDUSTRIES = {
  ...
  cafe: {
    ...
    services: [
      ...
      ['Fresh pastries', 'Baked every morning and usually gone by noon, so arrive early for the good stuff.'],
  ...
  bakery: {
    ...
    services: [
      ['Artisan breads', 'Naturally leavened loaves with real crust and crumb, baked before sunrise and sold the same day.'],
  ...
  auto: {
    ...
    services: [
      ['Diagnostics & inspection', 'We find the actual fault, show it to you, and only then recommend a repair.'],
  ...
  professional: {
    ...
    values: [
      ...
      ['Your advocate', 'We work for your outcome, start to finish, never the path of least resistance.'],
  ...
  retail: {
    ...
    services: [
      ...
      ['Expert recommendations', 'Tell us who it is for and what they love, and we will find the right thing.'],
  ...
  hospitality: {
    ...
    services: [
      ['Comfortable rooms', 'Quiet, spotless rooms with genuinely good beds, which is the thing that actually matters.'],
...
// ---------- conversion layer ----------
// The hook answers "why you, why now, what do I get" — a mood tagline
// ("Good food, made right") cannot. Each hook composes with the real city so
// it is specific to this business, and each promise is a concrete deliverable
// the owner can stand behind (not a superlative). `steps` is a genuinely
// sequential how-it-works, which is why numbered markers are legitimate there.
const CONVERSION = {
  restaurant: {
    hooks: ['A table in {city}, worth the trip.', 'Real cooking, five minutes from home.', 'The {city} kitchen your friends keep recommending.'],
    promise: ['Made fresh to order', 'Local, seasonal ingredients', 'Room for groups and walk-ins'],
    steps: [['Call or drop in', 'Tell us the day, time, and how many.'], ['We hold your table', 'You get a confirmation, not a maybe.'], ['Come hungry', 'We handle the rest.']],
  },
  cafe: {
    hooks: ['Your morning, done properly in {city}.', 'The coffee {city} actually crosses town for.', 'Good coffee, no queue, no fuss.'],
    promise: ['Beans roasted for espresso', 'Fast at the morning rush', 'Somewhere to sit and stay'],
    steps: [['Stop in', 'No booking, no minimum.'], ['Tell us how you take it', 'We will get it right the first time.'], ['Stay or take it with you', 'Either way, in and out fast.']],
  },
  bakery: {
    hooks: ['Fresh from the oven, every morning in {city}.', 'Real bread in {city}, baked overnight.', 'Baked this morning. Gone by afternoon.'],
    promise: ['Baked fresh daily on site', 'Order ahead for pickup', 'Custom orders welcome'],
    steps: [['Call ahead or walk in', 'Tell us what you need and when.'], ['We bake it fresh', 'Nothing sits overnight.'], ['Pick it up warm', 'Ready at the time we agree.']],
  },
  salon: {
    hooks: ['Book a chair in {city} this week.', 'The {city} salon people book ahead for.', 'A cut you will actually want to keep.'],
    promise: ['Unhurried appointments', 'A real consultation first', 'Honest advice before we start'],
    steps: [['Get in touch', 'Tell us what you are after.'], ['We talk it through', 'A proper consultation, no pressure.'], ['You leave happy', 'Styled, with advice you can repeat at home.']],
  },
  trades: {
    hooks: ['{cat} in {city}, done right the first time.', 'The {city} {cat} your neighbors call back.', 'Need a {cat} in {city}? Start with a free quote.'],
    promise: ['Free written quotes', 'Licensed and insured work', 'We clean up before we leave'],
    steps: [['Tell us the problem', 'A quick call is usually enough.'], ['We quote it in writing', 'You see the price before any work starts.'], ['We fix it properly', 'Tested, tidied, and warrantied.']],
  },
  auto: {
    hooks: ['{city} auto repair without the runaround.', 'Straight answers on your car, in {city}.', 'Diagnosed properly, fixed once.'],
    promise: ['We explain before we fix', 'No work without your say-so', 'Written estimates every time'],
    steps: [['Book it in', 'Tell us the symptoms.'], ['We diagnose and call you', 'You approve the price before we start.'], ['Back on the road', 'With a clear record of what was done.']],
  },
  health: {
    hooks: ['Taking new patients in {city}.', 'Unhurried care in {city}, when you need it.', 'A practice that runs on time.'],
    promise: ['New patients welcome', 'Appointments that start on time', 'Clear costs before treatment'],
    steps: [['Get in touch', 'Tell us what you need.'], ['We find you a time', 'Including early and late slots.'], ['You are seen properly', 'Unhurried, with everything explained.']],
  },
  fitness: {
    hooks: ['Start training in {city} this week.', 'The {city} gym that actually helps you.', 'Real coaching, not a turnstile.'],
    promise: ['Coaching, not just equipment', 'Beginners genuinely welcome', 'No long lock-in contracts'],
    steps: [['Come for a look', 'No pressure, no hard sell.'], ['We build your plan', 'Based on where you are now.'], ['You get going', 'With someone tracking your progress.']],
  },
  professional: {
    hooks: ['Straight advice in {city}, no jargon.', 'A {cat} in {city} who returns calls.', 'Get a clear answer before you commit.'],
    promise: ['Free initial consultation', 'Fixed fees agreed upfront', 'We answer our own phone'],
    steps: [['Book a first conversation', 'No charge, no obligation.'], ['We scope the work', 'You get the fee in writing.'], ['We get it done', 'With updates you do not have to chase.']],
  },
  retail: {
    hooks: ['Worth the trip in {city}.', 'The {city} shop worth leaving the house for.', 'Chosen by hand, not by algorithm.'],
    promise: ['Everything chosen by hand', 'Advice from people who use it', 'Easy returns, no argument'],
    steps: [['Come in or call', 'Tell us what you are after.'], ['We help you choose', 'Honest advice, including "not that one".'], ['Take it home', 'With a return if it is not right.']],
  },
  hospitality: {
    hooks: ['Somewhere to stay in {city} that feels like somewhere.', 'Check availability in {city}.', 'A real welcome, not a check-in desk.'],
    promise: ['Direct booking, best rate', 'Flexible arrival times', 'Local advice from people who live here'],
    steps: [['Check availability', 'Call or message us directly.'], ['We hold your room', 'Confirmed, with a flexible arrival.'], ['You arrive to a welcome', 'Not a queue.']],
  },
  generic: {
    hooks: ['{cat} in {city}, done properly.', 'The {city} {cat} people recommend.', 'Local, reliable, and easy to reach.'],
    promise: ['Straight answers', 'Fair, upfront pricing', 'Local and easy to reach'],
    steps: [['Get in touch', 'Tell us what you need.'], ['We agree the details', 'Including what it costs.'], ['We deliver', 'And stand behind it.']],
  },
};
...
const HEADINGS = {
  ...
  reviewsTitle: ['What Our Customers Say', 'In Their Own Words', 'From the Neighborhood', 'Reviews & Ratings'],
  servicesIntro: [
...
export async function enrichLead(lead) {
  ...
  // The hook: composed with the real city/category so it is specific to this
  // business, with the mood tagline kept as the supporting line.
  const conv = CONVERSION[industryKey] || CONVERSION.generic;
  const cityName = lead.city || 'town';
  const catWord = String(lead.category || 'business').toLowerCase();
  const hook = pick(conv.hooks, lead.id, 15)
    .replaceAll('{city}', cityName)
    .replaceAll('{cat}', catWord);

  const profile = {
    industry: industryKey,
    theme: industry.theme,
    hook,
    promise: conv.promise,
    steps: conv.steps,
    ...
    headings: {
      ...
      reviewsTitle: pick(HEADINGS.reviewsTitle, lead.id, 14),
